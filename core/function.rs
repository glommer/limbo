...
impl Func {
    ...
    pub fn resolve_function(name: &str, arg_count: usize) -> Result<Self, LimboError> {
        ...
        match normalized_name.as_str() {
            ...
            "format_type" => Ok(Self::Scalar(ScalarFunc::PgFormatType)),
            "pg_get_expr" => Ok(Self::Scalar(ScalarFunc::PgGetExpr)),
            "array_to_string" => Ok(Self::Scalar(ScalarFunc::PgArrayToString)),
            "pg_get_statisticsobjdef_columns" => Ok(Self::Scalar(ScalarFunc::PgGetStatisticsObjDefColumns)),
            "pg_relation_is_publishable" => Ok(Self::Scalar(ScalarFunc::PgRelationIsPublishable)),
            "array_upper" => Ok(Self::Scalar(ScalarFunc::PgArrayUpper)),
